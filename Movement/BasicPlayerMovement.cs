...
{
    [CreateAssetMenu(fileName = "Basic Player Movement", menuName = "SPToolkits/Motion Suppliers/Basic Player Movement")]
    public class BasicPlayerMovement : MotionSupplier
    {
