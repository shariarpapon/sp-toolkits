...
namespace SPToolkits.Records
{
    /// <summary>
    /// Holds a catalog of unlockable values. Ummm.. yes its just a list but whatever.
    /// </summary>
    public sealed class Unlockable<T>
    {
        ...
        public Unlockable(int capacity)
        {
            _unlockedValues = new List<T>(capacity);
        }
        ...
        /// <summary>
        /// Clears the unlocked value list.
        /// </summary>
        public void Clear() 
        {
